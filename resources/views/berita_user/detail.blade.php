                    ...
                    <div class="row justify-content-center align-items-center h-100">
                        <div class="text-center">
                            <div class="mt-5">
                                ...
                                <br>
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $berita->image) }}" alt="Gambar Berita" class="rounded" style="max-width: 50%; height: auto;">
                                </div>
                                <br>
                                <p class="text-muted mb-0" style="text-align: justify;">{!! nl2br(e ($berita->deskripsi)) !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
